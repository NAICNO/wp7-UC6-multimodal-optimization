# Visualization Guide for Multi-Modal Optimization
...
**Commits**:
- f41ebec - Fix plot z-axis scaling for 2D functions
- 7a745a2 - Fix plot z-axis scaling for 3D/4D+ functions
- 81307e7 - Fix math domain error by clipping grid points to domain bounds
- f4579d2 - Add domain clipping before how_many_goptima in notebook
- e8c66f8 - Add domain clipping in all plot evaluation points (comprehensive fix)
